...
long Distance()   //  
{
  ...
  Fdistance = map(Fdistance, 1, 438, 0, 100);
...
void LeftDetection()
{
  Serial.println("Servo motor turning left");
  setServoAngle(20);
  leftDistance=Distance();
}
void RightDetection()
{
  Serial.println("Servo motor turning right");
  setServoAngle(160);
...
void loop() {
  ...
  if(buttonState==HIGH)
  {
    ...
    checkGas();
    if(buttonStateLdr== HIGH && buttonState==HIGH)
    {
      ...
      intensity=200;digitalWrite(led,LOW);
    }
